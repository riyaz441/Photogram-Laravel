                                ...
                                <div class="col-sm-12">
                                    ...
                                    @if ($key == '')
                                        <button type="button" id="follow"
                                            class="btn btn-info mx-auto d-block mt-3">Follow</button>
                                    @elseif ($key !== false)
                                        <button type="button" id="follow"
                                            class="btn btn-danger mx-auto d-block mt-3">Unfollow</button>
                                    @else
                                        <button type="button" id="follow"
                                            class="btn btn-info mx-auto d-block mt-3">Follow</button>
                                    @endif
